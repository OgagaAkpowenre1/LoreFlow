...
//   console.log(`🎬 SceneNode Rendered: ${data.title}`);
...
// React Flow re-renders its whole node list internally on things like drag.
// Without memo, every node component re-executes regardless of whether its
// own props changed. memo adds a shallow-compare bail-out so SceneNode only
// re-renders when its own id/data/selected actually change.
