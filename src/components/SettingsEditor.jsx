...
// ════════════════════════════════════════════ */
// function SchemaTab() {
//   const { schema, addFieldToSchema, removeFieldFromSchema, lists, listMetadata } =
//     useLoreStore();
...
//           // Identify structural engine components that cannot be changed into scalar values
//           const isStructural = [
//             "sequence",
//             "choice_list",
//             "flag_group",
...
//                           // If converting to a list, assign a default source to prevent crashes
...
//                             payload.listId = undefined; // Drop the stale list reference
//                           }
...
//                     {/* LIVE SOURCE REMAPPER (Only shows if type is currently 'list') */}
//                     {field.type === "list" && (
...
//   // Track unique string variable enum addition text inputs
...
//       addToList(listId, {
//         // name: val.toLowerCase().replace(/\s+/g, "_"),
...
//     // const cleanVal = rawVal.trim().toLowerCase().replace(/\s+/g, "_");
//     const cleanVal = rawVal.trim().replace(/\s+/g, "_");
...
//               {/* Items Dynamic Inner Viewport Area */}
//               <div
...
//                         {/* ── INLINE ENUM OPTION MANAGEMENT AREA FOR STRING VARIABLES ── */}
//                         {item.type === "string" && (
...
//             if (i.t === "string") {
//               defVal = "";
//               setupPayload.allowedValues = []; // Initialize configuration array
//             }
//             return {
//               // name: i.val.trim().toLowerCase().replace(/\s+/g, "_"),
//               name: i.val.trim().replace(/\s+/g, "_"),
//               type: i.t,
//               defaultValue: defVal,
//               ...setupPayload,
//             };
...
//       // Coerced fallback sequence chain
...
//                                 /* 🏆 ENUM SELECTION DROPDOWN: Safeguards global routing options from typing failures */
//                                 <select
//                                   value={
...
import {
  ...
  Terminal,
  Tag,
  Lock, // <-- This missing import caused the Illegal Constructor crash!
} from "lucide-react";
