  ...
  return (
    <>
      ...
      >
        ...
        {/* Added w-max to ensure the background pill stretches to cover all buttons */}
        <div className="mt-6 flex flex-wrap lg:flex-nowrap items-center gap-4 bg-white/90 backdrop-blur-md px-6 py-3 rounded-2xl border border-white shadow-2xl w-max">
          ...
          <div className="flex items-center gap-2 relative z-[300] shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 bg-gray-100 text-gray-600 rounded-xl text-xs font-bold hover:bg-gray-200 transition-all shadow-sm"
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" && handleCreateNewGroup()
                    }
                  />
                  <button
      ...
      {/* ── INJECTED: Spotlight Search Modal ── */}
      <SearchModal
