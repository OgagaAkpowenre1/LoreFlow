...
// var story_data = {} # Loaded from your exported JSON
// var game_vars = { "wolf_dead": false, "gold_amount": 100 } # Your game state

// func start_conversation(npc_id: String):
// 	var rules = story_data.registry[npc_id]
// 	var graph_to_load = ""

// 	# 1. EVALUATE THE REGISTRY (Phase 3 logic)
// 	for rule in rules:
// 		if rule.condition == null or evaluate_condition(rule.condition):
// 			graph_to_load = rule.graph
// 			break # Found the highest priority match!

// 	# 2. RUN THE GRAPH (Phase 2 logic)
// 	load_and_process_graph(graph_to_load)

// func evaluate_condition(cond):
// 	var val = game_vars[cond.variable]
// 	match cond.op:
